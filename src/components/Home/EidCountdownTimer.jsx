      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-purple-900 to-indigo-900 rounded-xl shadow-2xl p-6">
        ...
        <div className="relative z-10">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-purple-200 text-sm">The celebration approaches...</p>
          </div>
              ...
              {[
                ...
                <div key={i} className="relative group">
                  ...
                  <div className="relative bg-black/50 backdrop-blur-sm rounded-lg p-2 flex flex-col items-center">
                    ...
                    <span className="text-purple-200 text-xs">{unit.label}</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          {showConfetti && (
            <div className="absolute inset-0 overflow-hidden">
              {Array.from({ length: 50 }).map((_, i) => {
                ...
                const color = ['bg-amber-400', 'bg-purple-400', 'bg-emerald-400', 'bg-pink-400', 'bg-blue-400'][Math.floor(Math.random() * 5)];
                return (
                  <div
                    key={i}
