...
import { Bell, Home, LogOut, Menu, MessageSquare, Settings, User, ShoppingBag, Heart, MapPin, CreditCard, Star, Package, ShoppingCart, BarChart2, Users, Truck, Store, FileText, DollarSign, Layers } from 'lucide-react';
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="pr-0 w-64">
              ...
              <nav className="flex flex-col gap-4 px-2 py-4">
                {navItems?.map((item, i) => (
                  <NavItem key={i} href={item?.href} icon={item?.icon} label={item?.label} active={pathname === item?.href} />
                ))}
              </nav>
            </SheetContent>
          </Sheet>
        ...
        <aside className="hidden w-64 flex-col border-r bg-background md:flex">
          <div className="flex p-4 items-center">
            <Link href="/" className=" font-semibold">
              <h3 className="text-xl text-orange-500">ShopSphere</h3>
              <p className='text-xs'>
                A Multi-vendor E-commerce Site
              </p>
            </Link>
