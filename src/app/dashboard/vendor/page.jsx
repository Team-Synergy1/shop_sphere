		...
		<div>
			...
			<div className="mt-6 grid gap-4 md:grid-cols-7 lg:grid-cols-7">
				...
				<Card className="md:col-span-4 lg:col-span-3">
					<CardHeader>
						...
						<CardDescription>
							Latest incoming orders for your store
						</CardDescription>
					</CardHeader>
					<CardContent>
			...
			<Card className="mt-6">
				...
				<CardContent>
					...
					<div className="mt-4 flex justify-end">
						<Button variant="outline" size="sm" asChild>
							<Link href="/dashboard/vendor/products">View All Products</Link>
						</Button>
					</div>
				</CardContent>
			</Card>
				...
				<Card className="md:col-span-3">
					...
					<CardContent>
						...
						<Button variant="outline" size="sm" className="mt-4 w-full" asChild>
							<Link href="/dashboard/vendor/inventory">Manage Inventory</Link>
						</Button>
					</CardContent>
				</Card>
